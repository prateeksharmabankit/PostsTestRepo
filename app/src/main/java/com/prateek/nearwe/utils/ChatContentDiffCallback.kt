...
class ChatContentDiffCallback(oldEmployeeList: List<Data>, newEmployeeList: List<Data>) :
    DiffUtil.Callback() {
    ...
    override fun areItemsTheSame(oldItemPosition: Int, newItemPosition: Int): Boolean {
        return mOldEmployeeList[oldItemPosition]._id == mNewEmployeeList[newItemPosition]._id &&mOldEmployeeList[oldItemPosition].message == mNewEmployeeList[newItemPosition].message
    }
